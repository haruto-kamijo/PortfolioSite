	...
	return (
		<section className="flex-none w-screen h-screen">
			<div className="profile relative">
				<div>
					<h1 className="relative text-xl z-10 lg:text-6xl bg-emerald-400 w-max pb-2 name-shadow-border">Haruto
						Kamijo</h1>
				...
				<div className="absolute text-xl z-10 lg:text-4xl self-introduction">
					<p className="relative bg-blue-500 ml-0 lg:ml-10 z-10 w-max self-introduction-shadow">self-introduction</p>
					<h2 className="relative text-lg z-10 lg:text-2xl pt-5">
