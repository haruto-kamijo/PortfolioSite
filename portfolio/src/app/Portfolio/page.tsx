		...
		<div className="flex h-screen p-0 double-gradation">
			...
			<div>
				...
				<div className="icon-contents">
					...
					<button className={count === 1? "icon-bg-active" : "icon-bg"} onClick={() => setCount(1)}>
					...
					<button className={count === 2 ? "icon-bg-active" : "icon-bg"} onClick={() => setCount(2)}>
						<svg className="h-16 w-16 text-purple-500" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5"
								 stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
							<path stroke="none" d="M0 0h24v24H0z"/>
					...
					<button className={count === 3 ? "icon-bg-active" : "icon-bg"} onClick={() => setCount(3)}>
					...
					<button className={count === 4 ? "icon-bg-active" : "icon-bg"} onClick={() => setCount(4)}>
					...
					<button className={count === 5 ? "icon-bg-active" : "icon-bg"} onClick={() => setCount(5)}>
